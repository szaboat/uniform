...
h3. _NEW!_ autoWidth(boolean)

*Default:* true
If this option is set to true, Uniform will attempt to automatically try to set the width of select elements based on their current width.
